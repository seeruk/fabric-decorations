...
package dev.seeruk.monsooncraft.inventory;
...
public class SimpleRecipeInputInventory implements Inventory, RecipeInputProvider, RecipeInputInventory {
    ...
    public SimpleRecipeInputInventory(ItemStack... items) {
